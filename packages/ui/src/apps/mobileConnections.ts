...
const MOBILE_CONNECTIONS_STORAGE_KEY = 'gridforge.mobile.connections.v1';
const MOBILE_SECURE_STORAGE_PREFIX = 'gridforge.mobile.';
const MOBILE_DEVICE_ID_STORAGE_KEY = 'gridforge.mobile.deviceId';
  ...
  const redeemPairingConnection = React.useCallback(async (payload: PairingConnectionPayload) => {
    ...
    try {
      ...
      const redeemBody = JSON.stringify({
        ...
        clientLabel: 'GridForge Mobile',
        clientKind: 'mobile',
        deviceName: 'GridForge Mobile',
  ...
  const submitPassword = React.useCallback(async (password: string) => {
    ...
    try {
      ...
      const loginInit = {
        ...
        body: JSON.stringify({ password, trustDevice: true, issueClientToken: true, clientLabel: 'GridForge Mobile', clientKind: 'mobile', devicePlatform: mobileDevicePlatform(), dedupeKey: mobileClientDedupeKey() }),
      };
