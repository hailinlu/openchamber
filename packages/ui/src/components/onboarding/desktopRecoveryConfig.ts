  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running GridForge. Verify the address points to a GridForge server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The GridForge server at "${host || 'unknown'}" is not compatible with this app version. Update GridForge on the server, then try again.`,
