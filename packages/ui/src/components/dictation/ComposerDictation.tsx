...
export const ComposerDictation: React.FC<ComposerDictationProps> = ({
    ...
    // The dictation server (WebSocket + STT worker) lives in the GridForge
    ...
    React.useEffect(() => {
        ...
        window.addEventListener('gridforge:dictation-toggle', onToggle);
        return () => window.removeEventListener('gridforge:dictation-toggle', onToggle);
