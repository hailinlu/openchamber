...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.weekStartsOn',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.macVibrancy',
    descriptionKey: 'settings.gridforge.visual.field.macVibrancyHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.dockBadge',
    descriptionKey: 'settings.gridforge.visual.field.dockBadgeHint',
    keywords: ['dock', 'badge', 'unread', 'unseen', 'counter', 'count', 'notification', 'macos'],
    // Exactly matches the render guard in GridforgeVisualSettings: any darwin
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.installAppName',
    descriptionKey: 'settings.gridforge.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.installOrientation',
    descriptionKey: 'settings.gridforge.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.gridforge.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.editor-font-size',
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.inputBarOffset',
    descriptionKey: 'settings.gridforge.visual.field.inputBarOffsetTooltip',
    keywords: ['input', 'home bar', 'offset'],
  },
  {
    id: 'appearance.expanded-editor-toolbar',
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.expandedEditorToolbar',
    keywords: ['editor', 'toolbar', 'tabs', 'docked', 'files'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.terminal-quick-keys',
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.gridforge.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.gridforge.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.gridforge.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.session-recap',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.sessionRecap',
    keywords: ['recap', 'assist', 'small model', 'summary'],
  },
  {
    id: 'chat.session-assistance',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.sessionAssistance',
    keywords: ['recap', 'suggestion', 'subagent'],
  },
  {
    id: 'chat.session-suggestion',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.sessionSuggestion',
    keywords: ['suggestion', 'assist', 'small model', 'follow up'],
  },
  {
    id: 'chat.session-goal',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.sessionGoal',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.gridforge.visual.goal.budgetLabel',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.prompt-navigator',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.promptNavigatorEnabled',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.gridforge.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.followUpBehavior',
    descriptionKey: 'settings.gridforge.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.gridforge.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.gridforge.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.gridforge.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.gridforge.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.gridforge.defaults.smallModel.title',
    descriptionKey: 'settings.gridforge.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.gridforge.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.gridforge.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.gridforge.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.gridforge.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'sessions',
    titleKey: 'settings.gridforge.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.gridforge.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.gridforge.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.gridforge.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.gridforge.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.desktopPassword.field.password',
    descriptionKey: 'settings.gridforge.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.gridforge.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.gridforge.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.gridforge.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.gridforge.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.gridforge.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.gridforge.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.gridforge.keyboardShortcuts.title',
    descriptionKey: 'settings.gridforge.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.gridforge.tunnel.field.provider',
    descriptionKey: 'settings.gridforge.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.gridforge.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.gridforge.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.gridforge.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.gridforge.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.gridforge.tunnel.field.configurationFile',
    descriptionKey: 'settings.gridforge.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.gridforge.tunnel.actions.startTunnel',
    descriptionKey: 'settings.gridforge.tunnel.note.connectLinksOneTime',
