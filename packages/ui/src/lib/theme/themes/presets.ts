...
import gridforge_dark_Raw from './fields-of-the-shire-dark.json';
import gridforge_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  gridforge_dark_Raw as Theme,
  gridforge_light_Raw as Theme,
