...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 GridForge 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'GridForge 已安装',
  ...
  'shareOpinion.toast.title': '帮助塑造 GridForge',
  ...
  'mobile.connect.welcome.title': '连接到 GridForge',
  ...
  'mobile.connect.password.placeholder': 'GridForge 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 GridForge 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutGridforge': '关于 GridForge',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 GridForge 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'sidebarFilesTree.menu.setCompareBase': '设为对比基准',
  'sidebarFilesTree.menu.compareWith': '与 {name} 对比',
  'sidebarFilesTree.menu.clearCompareBase': '取消对比基准',
  ...
  'aboutDialog.diagnosticsDescription': '包含 GridForge 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 GridForge',
  ...
  'header.actions.openAppMenu': 'GridForge 菜单',
  'header.actions.openAppMenuAria': '打开 GridForge 菜单',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 GridForge，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 GridForge',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 GridForge 服务器之间切换',
  ...
  'multiRun.window.description': 'GridForge 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 GridForge',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 GridForge 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 GridForge 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 GridForge 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 GridForge 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 GridForge 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 GridForge。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 GridForge，但与此应用版本不兼容。请更新服务器上的 GridForge 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 GridForge。请确认地址是否指向 GridForge 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 GridForge。请确认地址是否指向 GridForge 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 GridForge 服务器与此应用版本不兼容。请更新服务器上的 GridForge 后重试。',
  ...
  'startup.initRecovery.description': 'GridForge 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：gridforge update',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 GridForge 打开。',
  ...
  'gridforgeLogo.aria.logo': 'GridForge 标志',
  ...
  'contextFileOpen.confirm.title': '文件较大',
  'contextFileOpen.confirm.description': '该文件有 {count} 行，打开可能会影响性能。是否继续？',
  'contextFileOpen.confirm.openAnyway': '继续打开',
  ...
  'sidebarFilesTree.compare.selectedCount': '已选 {count} 个文件',
  'sidebarFilesTree.compare.compareButton': '比对选中文件',

  'fileCompare.title': '文件比对',
  'fileCompare.swap': '交换',
  'fileCompare.sideBySide': '并排',
  'fileCompare.unified': '统一视图',
  'fileCompare.wrapLines': '自动换行',
  'fileCompare.loading': '正在读取文件...',
  'fileCompare.error.missingFiles': '缺少比对文件',
  'fileCompare.error.readNotAvailable': '文件读取功能不可用',
  'fileCompare.warning.largeFileTitle': '文件较大',
  'fileCompare.warning.largeFileDescription': '选中的文件共 {sizeMb}MB，比对可能会影响性能。是否继续？',
  'fileCompare.warning.compareAnyway': '继续比对',
  'fileCompare.binaryNotSupported': '暂不支持二进制文件比对',
};
