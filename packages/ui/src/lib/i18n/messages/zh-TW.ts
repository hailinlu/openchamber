...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 GridForge 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'GridForge 已安裝',
  ...
  'shareOpinion.toast.title': '協助塑造 GridForge',
  ...
  'mobile.connect.welcome.title': '連線至 GridForge',
  ...
  'mobile.connect.password.placeholder': 'GridForge 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 GridForge 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 GridForge Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 GridForge 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 GridForge。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 GridForge，但與此應用程式版本不相容。請更新伺服器上的 GridForge 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 GridForge 伺服器與此應用程式版本不相容。請更新伺服器上的 GridForge 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutGridforge': '關於 GridForge',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 GridForge 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'sidebarFilesTree.menu.setCompareBase': '設為對比基準',
  'sidebarFilesTree.menu.compareWith': '與 {name} 對比',
  'sidebarFilesTree.menu.clearCompareBase': '取消對比基準',
  ...
  'header.services.shutdownDev': '停止 GridForge',
  ...
  'aboutDialog.gridforgeVersionLabel': 'GridForge 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 GridForge 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 GridForge',
  ...
  'header.actions.openAppMenu': 'GridForge 選單',
  'header.actions.openAppMenuAria': '開啟 GridForge 選單',
  ...
  'chat.statusRow.actions.collapseTasksAria': '收合任務列表',
  'chat.statusRow.actions.expandTasksAria': '展開任務列表',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 GridForge，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 GridForge',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 GridForge 伺服器之間切換',
  ...
  'multiRun.window.description': 'GridForge 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 GridForge',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 GridForge 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 GridForge 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 GridForge 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 GridForge 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 GridForge 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 GridForge。請確認位址是否指向 GridForge 伺服器。',
  ...
  'onboarding.desktopRecovery.localUnavailable.showErrorDetails': '顯示錯誤詳細資料',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 GridForge。請確認位址是否指向 GridForge 伺服器。',
  ...
  'startup.initRecovery.description': 'GridForge 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 GridForge...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：gridforge update',
  'mobileUpdate.toast.available.title': 'GridForge 更新可用',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 GridForge 開啟。',
  ...
  'gridforgeLogo.aria.logo': 'GridForge 標誌',
