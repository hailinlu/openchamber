...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 GridForge',
  ...
  'aboutDialog.openChamberVersionLabel': 'GridForge 版本 {version}',
  ...
  'openChamberLogo.aria.logo': 'GridForge 標誌',
