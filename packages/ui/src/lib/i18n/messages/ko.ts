...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'GridForge 정보',
  ...
  'aboutDialog.openChamberVersionLabel': 'GridForge 버전 {version}',
  ...
  'openChamberLogo.aria.logo': 'GridForge 로고',
