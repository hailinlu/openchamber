...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About GridForge',
  ...
  'aboutDialog.openChamberVersionLabel': 'GridForge version {version}',
  ...
  'openChamberLogo.aria.logo': 'GridForge logo',
