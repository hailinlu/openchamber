...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install GridForge for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'GridForge installed',
  ...
  'shareOpinion.toast.title': 'Help shape GridForge',
  ...
  'mobile.connect.welcome.title': 'Connect to GridForge',
  ...
  'mobile.connect.password.placeholder': 'GridForge password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an GridForge connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that GridForge server.',
  ...
  'sessions.sidebar.footer.actions.aboutGridforge': 'About GridForge',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to GridForge — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'sidebarFilesTree.menu.setCompareBase': 'Set as Compare Base',
  'sidebarFilesTree.menu.compareWith': 'Compare with {name}',
  'sidebarFilesTree.menu.clearCompareBase': 'Clear Compare Base',
  ...
  'header.services.shutdownDev': 'Stop GridForge',
  ...
  'aboutDialog.gridforgeVersionLabel': 'GridForge version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes GridForge state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate GridForge efficiently',
  ...
  'header.actions.openAppMenu': 'GridForge menu',
  'header.actions.openAppMenuAria': 'Open GridForge menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening GridForge from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock GridForge',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote GridForge servers',
  ...
  'multiRun.window.description': 'GridForge Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to GridForge',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If GridForge does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of GridForge — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to GridForge settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an GridForge server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an GridForge server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different GridForge version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running GridForge but is not compatible with this app version. Update GridForge on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running GridForge. Verify the address points to an GridForge server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.showErrorDetails': 'Show error details',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running GridForge. Verify the address points to an GridForge server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The GridForge server at "{host}" is not compatible with this app version. Update GridForge on the server, then try again.',
  ...
  'startup.initRecovery.description': 'GridForge could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating GridForge...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: gridforge update',
  'mobileUpdate.toast.available.title': 'GridForge update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep GridForge open.',
  ...
  'gridforgeLogo.aria.logo': 'GridForge logo',
