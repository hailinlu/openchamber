...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj GridForge, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'GridForge został zainstalowany',
  ...
  'shareOpinion.toast.title': 'Pomóż kształtować GridForge',
  ...
  'mobile.connect.welcome.title': 'Połącz z GridForge',
  ...
  'mobile.connect.password.placeholder': 'Hasło GridForge',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia GridForge.',
  ...
  'mobile.connect.relay.badge': 'przez GridForge Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem GridForge.',
  ...
  'sessions.sidebar.footer.actions.aboutGridforge': 'O GridForge',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia GridForge.',
  ...
  'onboarding.chooser.title': 'Witaj w GridForge',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli GridForge nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień GridForge i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera GridForge aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer GridForge, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji GridForge. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia GridForge, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj GridForge na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim GridForge. Zweryfikuj czy adres wskazuje na serwer GridForge.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia GridForge. Zweryfikuj czy adres wskazuje na serwer GridForge.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer GridForge pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj GridForge na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'GridForge nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan GridForge, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.gridforgeVersionLabel': 'Wersja GridForge {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do GridForge — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami GridForge',
  ...
  'header.actions.openAppMenu': 'Menu GridForge',
  'header.actions.openAppMenuAria': 'Otwórz menu GridForge',
  ...
  'header.services.shutdownDev': 'Zatrzymaj GridForge',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po GridForge.',
  ...
  'gridforgeLogo.aria.logo': 'Logo GridForge',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz GridForge z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj GridForge',
  ...
  'sidebarFilesTree.menu.setCompareBase': 'Ustaw jako bazę porównania',
  'sidebarFilesTree.menu.compareWith': 'Porównaj z {name}',
  'sidebarFilesTree.menu.clearCompareBase': 'Wyczyść bazę porównania',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: gridforge update',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja GridForge',
  ...
  'updateDialog.header.updating': 'Aktualizowanie GridForge...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw GridForge otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce GridForge — zainstaluj je, aby zacząć.',
  ...
  'settings.gridforge.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.gridforge.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.gridforge.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.gridforge.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.gridforge.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.gridforge.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.gridforge.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.gridforge.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
  ...
  'contextFileOpen.confirm.title': 'Large file',
  'contextFileOpen.confirm.description': 'This file has {count} lines. Opening may affect performance. Continue?',
  'contextFileOpen.confirm.openAnyway': 'Open anyway',
...
'sidebarFilesTree.compare.selectedCount': '{count} files selected',
  'sidebarFilesTree.compare.compareButton': 'Compare Selected',

  'fileCompare.title': 'File Compare',
  'fileCompare.swap': 'Swap',
  'fileCompare.sideBySide': 'Side by Side',
  'fileCompare.unified': 'Unified',
  'fileCompare.wrapLines': 'Wrap Lines',
  'fileCompare.loading': 'Reading files...',
  'fileCompare.error.missingFiles': 'Missing files to compare',
  'fileCompare.error.readNotAvailable': 'File read is not available',
  'fileCompare.warning.largeFileTitle': 'Large file comparison',
  'fileCompare.warning.largeFileDescription': 'The selected files total {sizeMb}MB. Comparison may be slow. Continue?',
  'fileCompare.warning.compareAnyway': 'Compare anyway',
  'fileCompare.binaryNotSupported': 'Binary files are not supported for comparison',
} as const;
