...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.about.title': '关于 GridForge',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 GridForge',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 GridForge',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 GridForge 最小化和关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '最小化和关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '主窗口最小化或关闭时，让 GridForge 继续在 Windows 系统托盘中运行。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'GridForge 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'GridForge 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'GridForge 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安装 GridForge',
  'settings.remoteInstances.page.phase.updatingOpenChamber': '正在更新 GridForge',
  ...
  'settings.openchamber.visual.field.showNonEditToolCalls': '显示非 Edit 工具调用',
  'settings.openchamber.visual.field.showNonEditToolCallsAria': '显示非 Edit 工具调用',
