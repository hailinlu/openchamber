export const settingsDict = {
  ...
  'settings.openchamber.about.title': 'About GridForge',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start GridForge at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start GridForge when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close GridForge to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps GridForge running in the Windows system tray when the main window is minimized or closed.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while GridForge is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while GridForge is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'GridForge asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing GridForge',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating GridForge',
