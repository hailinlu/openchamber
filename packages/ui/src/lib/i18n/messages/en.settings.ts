export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. GridForge never scans browser cookie storage.',
  ...
  'settings.window.description': 'GridForge settings window.',
  ...
  'settings.gridforge.tunnel.title': 'Remote Tunnel',
  'settings.gridforge.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.gridforge.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.gridforge.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.gridforge.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.gridforge.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.gridforge.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.gridforge.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.gridforge.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.gridforge.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.gridforge.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.gridforge.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.gridforge.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.gridforge.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.gridforge.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.gridforge.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.gridforge.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.gridforge.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.gridforge.tunnel.field.provider': 'Provider',
  'settings.gridforge.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.gridforge.tunnel.field.tunnelType': 'Tunnel type',
  'settings.gridforge.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.gridforge.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.gridforge.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.gridforge.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.gridforge.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.gridforge.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.gridforge.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.gridforge.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.gridforge.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.gridforge.tunnel.field.configurationFile': 'Configuration file',
  'settings.gridforge.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.gridforge.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.gridforge.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.gridforge.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.gridforge.tunnel.field.connectLink': 'Connect link',
  'settings.gridforge.tunnel.field.expires': 'Expires',
  'settings.gridforge.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.gridforge.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.gridforge.tunnel.actions.saveToken': 'Save token',
  'settings.gridforge.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.gridforge.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.gridforge.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.gridforge.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.gridforge.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.gridforge.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.gridforge.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.gridforge.tunnel.actions.stopping': 'Stopping...',
  'settings.gridforge.tunnel.actions.newConnectLink': 'New connect link',
  'settings.gridforge.tunnel.actions.copied': 'Copied',
  'settings.gridforge.tunnel.actions.retry': 'Retry',
  'settings.gridforge.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.gridforge.tunnel.option.mode.quick.label': 'Quick',
  'settings.gridforge.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.gridforge.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.gridforge.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.gridforge.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.gridforge.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.gridforge.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.gridforge.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.gridforge.tunnel.state.loading': 'Loading',
  'settings.gridforge.tunnel.state.expired': 'Expired',
  'settings.gridforge.tunnel.state.revoked': 'Revoked',
  'settings.gridforge.tunnel.state.inactive': 'Inactive',
  'settings.gridforge.tunnel.state.noExpiry': 'No expiry',
  'settings.gridforge.tunnel.state.never': 'Never',
  'settings.gridforge.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.gridforge.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.gridforge.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.gridforge.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.gridforge.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.gridforge.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/gridforge/cloudflare-managed-remote-tunnels.json.',
  'settings.gridforge.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.gridforge.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.gridforge.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.gridforge.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.gridforge.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.gridforge.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.gridforge.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.gridforge.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.gridforge.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.gridforge.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.gridforge.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.gridforge.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.gridforge.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.gridforge.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.gridforge.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.gridforge.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.gridforge.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.gridforge.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.gridforge.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.gridforge.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.gridforge.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.gridforge.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.gridforge.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.gridforge.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.gridforge.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.gridforge.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other GridForge servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another GridForge server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another GridForge server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid GridForge connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so GridForge Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the GridForge app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through GridForge Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the GridForge app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether GridForge should start the server for you, or connect to one that is already running.',
  ...
  'settings.gridforge.about.title': 'About GridForge',
  'settings.gridforge.about.field.version': 'Version',
  'settings.gridforge.about.field.openCodeVersion': 'OpenCode version',
  'settings.gridforge.about.state.checking': 'Checking...',
  'settings.gridforge.about.state.upToDate': 'Up to date',
  'settings.gridforge.about.state.unknown': 'unknown',
  'settings.gridforge.about.actions.checkUpdates': 'Check updates',
  'settings.gridforge.about.actions.update': 'Update',
  'settings.gridforge.about.actions.updateToVersion': 'Update to {version}',
  'settings.gridforge.about.actions.checkForUpdates': 'Check for updates',
  'settings.gridforge.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.agents.page.field.systemPromptPlaceholder': 'You are an expert coding assistant.\n\nWhen updating the todo list with TodoWrite, NEVER remove or overwrite tasks already marked as `completed`. Completed tasks are a progress record and must stay visible until the entire list is reset. When splitting work into sub-tasks, insert new entries into the pending queue or replace only `pending`/`in_progress` items — never `completed` ones. Sub-tasks MUST use fresh `content` strings — never reuse the `content` of a `completed` task, and never reuse the `content` of another pending/in_progress item either. When updating a task\'s `content`, do not reword or paraphrase the original description — you may APPEND a short result suffix (e.g. "✅", "(68.2%)") to a completed task, but the original description must remain intact at the front.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. GridForge will scan it for folders containing',
  ...
  'settings.gridforge.passkeys.title': 'Passkeys',
  'settings.gridforge.passkeys.field.currentDevice': 'Current device',
  'settings.gridforge.passkeys.actions.add': 'Add passkey',
  'settings.gridforge.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.gridforge.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.gridforge.passkeys.actions.signingOut': 'Signing out…',
  'settings.gridforge.passkeys.actions.removing': 'Removing…',
  'settings.gridforge.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.gridforge.passkeys.state.loading': 'Loading passkeys…',
  'settings.gridforge.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.gridforge.passkeys.item.lastUsed': 'Last used {time}',
  'settings.gridforge.passkeys.item.added': 'Added {time}',
  'settings.gridforge.passkeys.time.neverUsed': 'Never used',
  'settings.gridforge.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.gridforge.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.gridforge.passkeys.toast.added': 'Passkey added',
  'settings.gridforge.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.gridforge.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.gridforge.passkeys.toast.removed': 'Passkey removed',
  'settings.gridforge.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.gridforge.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.gridforge.sessionRetention.title': 'Session Retention',
  'settings.gridforge.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.gridforge.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.gridforge.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.gridforge.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.gridforge.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.gridforge.sessionRetention.field.days': 'days',
  'settings.gridforge.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.gridforge.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.gridforge.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.gridforge.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.gridforge.sessionRetention.action.archive': 'Archive',
  'settings.gridforge.sessionRetention.action.delete': 'Delete',
  'settings.gridforge.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.gridforge.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.gridforge.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.gridforge.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.gridforge.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.gridforge.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.gridforge.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.gridforge.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.gridforge.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.gridforge.desktopNetwork.title': 'Desktop Network Access',
  'settings.gridforge.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.gridforge.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Auto follows your operating system.',
  'settings.gridforge.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.gridforge.desktopNetwork.option.windowControlsAuto': 'Auto',
  'settings.gridforge.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.gridforge.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.gridforge.desktopNetwork.field.launchAtLoginAria': 'Start GridForge at login',
  'settings.gridforge.desktopNetwork.field.launchAtLogin': 'Start GridForge when you log in',
  'settings.gridforge.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.gridforge.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close GridForge to the system tray',
  'settings.gridforge.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.gridforge.desktopNetwork.field.minimizeToTrayDescription': 'Keeps GridForge running in the Windows system tray when the main window is minimized or closed.',
  'settings.gridforge.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while GridForge is running',
  'settings.gridforge.desktopNetwork.field.keepAwake': 'Keep computer awake while GridForge is running',
  'settings.gridforge.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.gridforge.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.gridforge.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.gridforge.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.gridforge.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.gridforge.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.gridforge.desktopPassword.field.password': 'Desktop UI Password',
  'settings.gridforge.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.gridforge.desktopPassword.field.passwordDescription': 'GridForge asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.gridforge.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.gridforge.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.gridforge.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.gridforge.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.gridforge.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.gridforge.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.gridforge.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.gridforge.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.gridforge.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.gridforge.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.gridforge.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.gridforge.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.gridforge.opencodeCli.title': 'OpenCode CLI',
  'settings.gridforge.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.gridforge.opencodeCli.tooltipSuffix': 'binary.',
  'settings.gridforge.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.gridforge.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.gridforge.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.gridforge.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.gridforge.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.gridforge.opencodeCli.actions.browse': 'Browse',
  'settings.gridforge.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.gridforge.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.gridforge.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.gridforge.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.gridforge.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.gridforge.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.gridforge.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.gridforge.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.gridforge.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.gridforge.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.gridforge.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.gridforge.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.gridforge.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.gridforge.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.gridforge.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.gridforge.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.gridforge.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.gridforge.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.gridforge.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.gridforge.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.gridforge.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.gridforge.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.gridforge.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.gridforge.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.gridforge.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.gridforge.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.gridforge.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.gridforge.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.gridforge.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.gridforge.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.gridforge.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.gridforge.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.gridforge.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.gridforge.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.gridforge.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.gridforge.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.gridforge.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.gridforge.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.gridforge.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open GridForge there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'GridForge on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how GridForge should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote GridForge server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote GridForge UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How GridForge should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingGridforge': 'Installing GridForge',
  'settings.remoteInstances.page.phase.updatingGridforge': 'Updating GridForge',
  ...
  'settings.gridforge.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.gridforge.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.gridforge.worktrees.setup.title': 'Setup commands',
  'settings.gridforge.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.gridforge.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.gridforge.worktrees.setup.loading': 'Loading...',
  'settings.gridforge.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.gridforge.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.gridforge.worktrees.setup.addCommand': 'Add command',
  'settings.gridforge.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.gridforge.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.gridforge.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.gridforge.worktrees.list.title': 'Existing worktrees',
  'settings.gridforge.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.gridforge.worktrees.list.loading': 'Loading worktrees...',
  'settings.gridforge.worktrees.list.empty': 'No worktrees found for this project',
  'settings.gridforge.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.gridforge.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by GridForge.',
  ...
  'settings.gridforge.defaults.title': 'Session Defaults',
  'settings.gridforge.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.gridforge.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.gridforge.defaults.field.defaultModel': 'Default Model',
  'settings.gridforge.defaults.field.defaultThinking': 'Default Thinking',
  'settings.gridforge.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.gridforge.defaults.field.defaultAgent': 'Default Agent',
  'settings.gridforge.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.gridforge.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.gridforge.defaults.smallModel.title': 'Small Model',
  'settings.gridforge.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.gridforge.defaults.smallModel.useDefault': 'Use default small model',
  'settings.gridforge.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.gridforge.defaults.smallModel.overrideModel': 'Override model',
  'settings.gridforge.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.gridforge.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.gridforge.defaults.option.default': 'Default',
  'settings.gridforge.defaults.option.defaultLowercase': 'default',
  'settings.gridforge.git.title': 'Git Preferences',
  'settings.gridforge.git.changesViewTitle': 'Changes View',
  'settings.gridforge.git.changesViewAria': 'Git changes view mode',
  'settings.gridforge.git.option.flatList': 'Flat List',
  'settings.gridforge.git.option.treeView': 'Tree View',
  'settings.gridforge.git.optionAria': 'Git changes view mode: {option}',
  'settings.gridforge.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.gridforge.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.gridforge.git.showGitignoredAria': 'Display gitignored files',
  'settings.gridforge.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize GridForge',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if GridForge auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from GridForge.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the GridForge server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the GridForge server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  'settings.gridforge.visual.section.colorMode': 'Color Mode',
  'settings.gridforge.visual.section.mobileLayout': 'Mobile Layout',
  'settings.gridforge.visual.option.mobileLayout.default': 'Old',
  'settings.gridforge.visual.option.mobileLayout.new': 'New',
  'settings.gridforge.visual.section.localization': 'Localization',
  'settings.gridforge.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.gridforge.visual.section.navigation': 'Navigation',
  'settings.gridforge.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.gridforge.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.gridforge.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.gridforge.visual.section.activityDefault': 'Activity Default',
  'settings.gridforge.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.gridforge.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.gridforge.visual.section.sessionAssistance': 'Session Assistance',
  'settings.gridforge.visual.section.reasoning': 'Reasoning',
  'settings.gridforge.visual.section.messageAppearance': 'Message Appearance',
  'settings.gridforge.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.gridforge.visual.section.composer': 'Composer',
  'settings.gridforge.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.gridforge.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.gridforge.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.gridforge.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.gridforge.visual.section.diffLayout': 'Diff Layout',
  'settings.gridforge.visual.section.diffLayoutAria': 'Diff layout',
  'settings.gridforge.visual.section.privacy': 'Privacy',
  'settings.gridforge.visual.field.lightTheme': 'Light Theme',
  'settings.gridforge.visual.field.darkTheme': 'Dark Theme',
  'settings.gridforge.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.gridforge.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.gridforge.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.gridforge.visual.field.timeFormat': 'Time Format',
  'settings.gridforge.visual.field.weekStartsOn': 'Week Starts On',
  'settings.gridforge.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.gridforge.visual.field.selectWeekStartAria': 'Select week start',
  'settings.gridforge.visual.actions.reloadThemes': 'Reload themes',
  'settings.gridforge.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.gridforge.visual.field.macVibrancy': 'Window transparency',
  'settings.gridforge.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.gridforge.visual.field.dockBadge': 'Dock badge',
  'settings.gridforge.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.gridforge.visual.actions.saveAndRestart': 'Save & restart',
  'settings.gridforge.visual.actions.restarting': 'Restarting…',
  'settings.gridforge.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.gridforge.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/gridforge/themes/',
  'settings.gridforge.visual.field.installAppName': 'Install App Name',
  'settings.gridforge.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.gridforge.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.gridforge.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.gridforge.visual.field.installOrientation': 'Install Orientation',
  'settings.gridforge.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.gridforge.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.gridforge.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.gridforge.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.gridforge.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.gridforge.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.gridforge.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.gridforge.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.gridforge.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.gridforge.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.gridforge.visual.field.interfaceFont': 'Interface Font',
  'settings.gridforge.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.gridforge.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.gridforge.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.gridforge.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.gridforge.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.gridforge.visual.field.editorFontSize': 'Editor Font Size',
  'settings.gridforge.visual.field.codeFont': 'Code Font',
  'settings.gridforge.visual.field.selectCodeFontAria': 'Select code font',
  'settings.gridforge.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.gridforge.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.gridforge.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.gridforge.visual.field.spacingDensity': 'Spacing Density',
  'settings.gridforge.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.gridforge.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.gridforge.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.gridforge.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.gridforge.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.gridforge.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.gridforge.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.gridforge.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.gridforge.visual.option.fileEditorKeymap.default': 'Default',
  'settings.gridforge.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.gridforge.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.gridforge.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.gridforge.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.gridforge.visual.field.bash': 'Bash',
  'settings.gridforge.visual.field.editTools': 'Edit tools',
  'settings.gridforge.visual.field.showNonEditToolCalls': 'Show non-Edit tool calls',
  'settings.gridforge.visual.field.showNonEditToolCallsAria': 'Show non-Edit tool calls',
  'settings.gridforge.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.gridforge.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.gridforge.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.gridforge.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.gridforge.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.gridforge.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.gridforge.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.gridforge.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.gridforge.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.gridforge.visual.goal.sectionTitle': 'Goal',
  'settings.gridforge.visual.goal.budgetLabel': 'Default token budget',
  'settings.gridforge.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.gridforge.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.gridforge.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.gridforge.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.gridforge.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.gridforge.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.gridforge.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.gridforge.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.gridforge.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.gridforge.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.gridforge.visual.field.promptNavigatorEnabledAria': 'Prompt navigator',
  'settings.gridforge.visual.field.promptNavigatorEnabled': 'Prompt Navigator',
  ...
  'settings.gridforge.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.gridforge.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.gridforge.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.gridforge.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.gridforge.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.gridforge.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.gridforge.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.gridforge.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.gridforge.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.gridforge.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.gridforge.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.gridforge.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.gridforge.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.gridforge.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.gridforge.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.gridforge.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.gridforge.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.gridforge.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.gridforge.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.gridforge.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.gridforge.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.gridforge.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.gridforge.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.gridforge.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.gridforge.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.gridforge.visual.option.themeMode.system': 'System',
  'settings.gridforge.visual.option.themeMode.light': 'Light',
  'settings.gridforge.visual.option.themeMode.dark': 'Dark',
  'settings.gridforge.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.gridforge.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.gridforge.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.gridforge.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.gridforge.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.gridforge.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.gridforge.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.gridforge.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.gridforge.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.gridforge.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.gridforge.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.gridforge.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.gridforge.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.gridforge.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.gridforge.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.gridforge.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.gridforge.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.gridforge.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.gridforge.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.gridforge.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.gridforge.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.gridforge.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.gridforge.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.gridforge.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.gridforge.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.gridforge.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.gridforge.visual.option.chatRenderMode.live.label': 'Live',
  'settings.gridforge.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.gridforge.visual.option.messageTransport.auto.label': 'Auto',
  'settings.gridforge.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.gridforge.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.gridforge.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.gridforge.visual.option.messageTransport.sse.label': 'SSE',
  'settings.gridforge.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.gridforge.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.gridforge.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.gridforge.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.gridforge.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.gridforge.visual.option.timeFormat.auto.label': 'Auto',
  'settings.gridforge.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.gridforge.visual.option.timeFormat.24h.label': '24-hour',
  'settings.gridforge.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.gridforge.visual.option.timeFormat.12h.label': '12-hour',
  'settings.gridforge.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.gridforge.visual.option.weekStart.auto.label': 'Auto',
  'settings.gridforge.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.gridforge.visual.option.weekStart.monday.label': 'Monday',
  'settings.gridforge.visual.option.weekStart.sunday.label': 'Sunday',
