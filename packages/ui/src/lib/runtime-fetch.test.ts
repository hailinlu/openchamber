  ...
  test('rewrites current-origin absolute API URLs only', () => {
    ...
    try {
      ...
      Object.defineProperty(globalThis, 'window', {
        configurable: true,
        value: { location: { origin: 'gridforge-ui://app', href: 'gridforge-ui://app/index.html' } },
      });

      expect(buildRuntimeFetchUrl('gridforge-ui://app/api/config/settings')).toBe('https://api.example/api/config/settings');
