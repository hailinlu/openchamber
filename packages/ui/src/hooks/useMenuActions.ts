...
const MENU_ACTION_EVENT = 'gridforge:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'gridforge:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('gridforge:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('gridforge:menu-action', (evt) => {
    ...
    listen('gridforge:check-for-updates', () => {
