...
pub const PROVIDER_ID: &str = "minimax-cn-coding-plan";
pub const PROVIDER_NAME: &str = "MiniMax Coding Plan (minimaxi.com)";
pub const ALIASES: &[&str] = &["minimax-cn-coding-plan"];
...
pub use fetch_quota as fetch_minimax_cn_coding_plan_quota;
